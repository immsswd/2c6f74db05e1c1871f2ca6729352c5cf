...
//    echo $dst = $_SERVER['DOCUMENT_ROOT']."/pustaka/imgbooks/".$tm.$fnm;
...
$query = "SELECT * FROM buku WHERE descr LIKE '%".$keywords[$i]."%'".
" ORDER BY id";
}
...
<div id="zoomTarget">
    <img data-targetsize="0.45" data-duration="600" class="img-responsive zoomTarget" src="<?=$row['fotobuku'] ?>" alt="<?=$row['judul'] ?>" width="80" height="100"><em class="text-danger">Kilk gambar (zoom)</em>
</div>
...
-->
    ...
    <p>Kode buku: <?php echo $row['kode'] ?><br>
        Rak buku: <?=$row['rakbuku']?><br>
