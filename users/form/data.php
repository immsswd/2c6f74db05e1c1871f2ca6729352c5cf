        ...
        <table class="table table-responsive table-hover">
            <tbody>
                ...
                <tr>
                    ...
                    <img src="<?=$row["foto"] ?>" width="100" height="100" class="img-rounded"></a>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $row["jenisidentitas"] ?>
                    </td>
                </tr>
                <tr>
                    <th>Nomor Identitas</th>
                    <td>
                        <?php echo $row["nomoridentitas"] ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $row["pendidikanterakhir"] ?>
                    </td>
                </tr>
                <tr>
...
?>
                <!--    disini isi modal data pengguna-->
                        ...
                        <div class="modal-content">
                            <div class="panel panel-default"><button type="button" class="close pull-right" data-dismiss="modal">&times;</button>
                                ...
                                <div class="panel-heading">
                                    <h3>Hallo <span class="text text-success"><?php echo ucwords($_SESSION['calonanggota']) ?></span></h3>
                                </div>
