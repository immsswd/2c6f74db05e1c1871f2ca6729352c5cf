...
$result=$dbase->query("SELECT * FROM peminjaman ORDER BY namaanggota ASC");
...
$pdf->SetY($Y_Table_Position);
$pdf->SetX(15);
$pdf->MultiCell(30,6,$column_na,0,'C');
$pdf->SetY($Y_Table_Position);
$pdf->SetX(45);
$pdf->MultiCell(40,6,$column_nama,0,'L');
$pdf->SetY($Y_Table_Position);
$pdf->SetX(85);
$pdf->MultiCell(30,6,$column_buku,0,'L');
$pdf->SetY($Y_Table_Position);
$pdf->SetX(115);
$pdf->MultiCell(60,6,$column_buku2,0,'L');
$pdf->SetY($Y_Table_Position);
$pdf->SetX(175);
$pdf->MultiCell(65,6,$column_kontak,0,'L');
$pdf->SetY($Y_Table_Position);
$pdf->SetX(240);
$pdf->MultiCell(40,6,$column_status,3,'C');
