...
$result=$dbase->query("SELECT * FROM peminjaman WHERE date(tglpeminjaman) >= '$_SESSION[tanggal1]' AND date(tglpeminjaman) <= '$_SESSION[tanggal2]' ORDER BY namaanggota ASC");
...
$pdf->Cell(130);
$pdf->Cell(30,5,'Laporan Peminjaman/Pengembalian Koleksi Buku',0,0,'C');
$pdf->Ln();
$pdf->Cell(130);
$pdf->Cell(30,5,'Perpustakaan Soeman HS',0,0,'C');
$pdf->Ln();
$pdf->Cell(130);
...
$pdf->SetX(15);
$pdf->Cell(30,8,'No Anggota',0,0,'C',1);
$pdf->SetX(45);
$pdf->Cell(40,8,'Nama',0,0,'C',1);
$pdf->SetX(85);
$pdf->Cell(30,8,'Tgl Peminjaman',0,0,'C',1);
$pdf->SetX(115);
$pdf->Cell(60,8,'Buku 1',0,0,'C',1);
$pdf->SetX(175);
$pdf->Cell(65,8,'Buku 2',0,0,'C',1);
$pdf->SetX(240);
$pdf->Cell(40,8,'Status',0,10,'C',1);
$pdf->Ln();
...
$pdf->SetY($Y_Table_Position);
$pdf->SetX(85);
$pdf->MultiCell(30,6,$column_buku,1,'J');
$pdf->SetY($Y_Table_Position);
$pdf->SetX(115);
$pdf->MultiCell(60,6,$column_buku2,1,'J');
$pdf->SetY($Y_Table_Position);
$pdf->SetX(175);
