<div class="col-md-2">
    <a href="index.php?modul=show_buku" class="btn btn-app"><i class="fa fa-hand-o-left"></i> Kembali ke list</a>
</div>
...
?>
        <center class="alert bg-warning">
            <img src="<?=$gambar?>" width="100" height="100" class="zooomin img img-responsive img-thumbnail">
            <h3>
                <?=$judul?>
            </h3>
