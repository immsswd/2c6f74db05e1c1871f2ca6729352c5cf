...
<div class="col-md-12">
    <?php
		...
		if (isset($_POST['updated'])) {
			...
			$stmt = $dbase->query("UPDATE anggota SET nama = '$unama', usernamea = '$uusername', jeniskelamin = '$ujeniskelamin', tempatlahir = '$utempatlahir', tgllahir = '$utgllahir', statuspekerjaan = '$upekerjaan', namainstansi = '$uinstansi', alamat = '$ualamat', kontak = '$ukontak', jenisanggota = '$ujenisanggota', jenisidentitas = '$ujenisidentitas', nomoridentitas = '$unomoridentitas' WHERE iduser = '$_SESSION[idedit]' ");
			if ($stmt) {
