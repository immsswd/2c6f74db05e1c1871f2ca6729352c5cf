<div class="col-md-12">
    <?php
        ...
        $q = $dbase->query("SELECT * FROM user_reg INNER JOIN anggota ON user_reg.id = anggota.iduser WHERE status_keanggotaan = 'Aktif' ORDER BY nama ASC");
        $q2 = $dbase->query("SELECT * FROM admin_reg ORDER BY firstname ASC");
        $anggta  = $dbase->query("SELECT * FROM anggota WHERE status_keanggotaan = 'Aktif'");
...
//        var_dump($res);
        $allm = $anggta->rowCount(PDO::FETCH_NUM);
//        var_dump($allm);
        $numb = 1;
    ?>
        <!-- ===============================Anggota List All============================ -->
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <ul>
                    ...
                    <li class="text-success"><strong>Jumlah Anggota aktif keseluruhan = <?=$allm?> Orang</strong></li>
                </ul>
            </div>
        </div>
        <!-- ===============================/Anggota List All============================ -->
