...
<?php
	...
	<tr>
		...
		<td><?php echo 'Pekanbaru, '.TanggalIndo($row['updated']); ?></td>
		<td><?php if ($row['status']=="no") {?>
			<a class='btn btn-sm btn-success' onclick="return confirm('Anda yakin ingin approve <?php echo $row['firstname'] ?> ?')" href='pages/approve.php?id=<?=$url?>'>Setujui? </a><span>Jika syarat sudah lengkap</span>
