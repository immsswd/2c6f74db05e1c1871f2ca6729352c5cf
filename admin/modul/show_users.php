<div class="col-md-12">
	<h2 class="text-center"><i class="fa fa-paperclip"></i> Anggota <span class="text-success">Aktif</span></h2><hr>
<hr>
<?php
...
<?php
	...
	<tr>
		...
		<?php 
            ...
            ?><hr>
            <a class='btn btn-sm btn-danger' onclick="return confirm('Anda yakin Menonaktifkan <?=$row->nama ?> ?')" href='pages/disapprove.php?id=<?=$url?>'>
