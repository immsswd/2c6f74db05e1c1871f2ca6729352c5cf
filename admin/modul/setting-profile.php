...
//                $username   = htmlentities($_POST['username']);
                ...
                if ($pass1 == $pass2) {
                    $query = $dbase->query("UPDATE admin_reg SET firstname = '$firstname', lastname = '$lastname', email = '$email', contact = '$contact', password = '$pass1', profile_img = '$dst' WHERE username = '$_SESSION[staffadmin]'");
