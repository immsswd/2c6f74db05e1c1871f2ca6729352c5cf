...
<div class="col-md-6">
	...
	<table class="table table-responsive table-hover table-striped">
		...
		<tbody>
			...
			<td>
				<?=$n?>
				<form method="post" action="index.php?pages=delmsg"><input type="hidden" name="pesan" value="<?=$ro->idpesan?>"><button onclick="confirm('yakin hapus pesan?')" data-placement="top" data-toggle="tooltip" data-original-title="Hapus pesan?" class="btn btn-xs" type="submit" name="idpesan"><i class="fa fa-trash"></i> hapus</button></form>		
			</td>
