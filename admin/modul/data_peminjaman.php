<div class="col-md-12">
	<h2 class="text-center"><i class="fa fa-paperclip"></i> Data Peminjaman Koleksi Buku</h2><hr>
<?php
...
<div class="col-md-4">
	...
	<h2 class="text-center"><i class="fa fa-paperclip"></i> Pilih berdasarkan Nama</h2>
	<hr>
	<form method="post" action="">
        <div class="input-group">
            ...
            ?>
                <option value="<?=$row->namaanggota?>"><?=$row->namaanggota?></option>
            <?php }?>
            </select>
