...
//		require ("fctn/tglid.php");
        ...
        ?>
                <tr>
                    <td>
                        <?=$no?><br>
                        <form method="post" action="index.php?pages=delpeminjaman">
                            <input name="idpeminjaman" type="hidden" value="<?=$row->idpeminjaman?>">
                            <button data-placement="top" data-toggle="tooltip" data-original-title="Hapus?" type="submit" name="hapus" class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i></button>
                        </form>
                    </td>
                    <td>
                        <?=$row->kodeanggota?>
