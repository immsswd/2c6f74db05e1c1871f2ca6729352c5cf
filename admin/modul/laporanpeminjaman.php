...
<div class="col-md-12">
	...
	// $h = $q->fetchAll();
        ...
        <div class="panel panel-default">
			...
			?>
                            <tr>
                                ...
                                <td>
                                    <?=TanggalIndo($s->tglpeminjaman)?>
                                </td>
                                <td>
                                    <?=TanggalIndo($s->tglpengembalian)?>
                                </td>
                                <?php
        ...
        <div class="panel-footer">
            <!--			<a href="export/exportlaporanpemdanpeng.php" class="btn btn-info" target="_blank"><i class=" fa fa-file-pdf-o"></i> Export Laporan</a>-->
            <form method="post" action="export/exportlaporanpemdanpeng.php" target="_blank">
                <input type="hidden" name="tanggal1" value="<?=$_SESSION['tanggal1']?>">
                <input type="hidden" name="tanggal2" value="<?=$_SESSION['tanggal2']?>">
                <button type="submit" name="cetak" class="btn btn-app"><i class="fa fa-print"></i> Export Laporan</button>
            </form>
        </div>
        <?php
		}
